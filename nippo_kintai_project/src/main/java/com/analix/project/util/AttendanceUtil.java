...
public class AttendanceUtil {
	...
	public static final LinkedHashMap<Byte, String> attendanceStatusForOutput = new LinkedHashMap<>();
	static {
		attendanceStatusForOutput.put((byte) 0, "通常出勤");
		attendanceStatusForOutput.put((byte) 3, "遅刻");
		attendanceStatusForOutput.put((byte) 6, "早退");
		attendanceStatusForOutput.put((byte) 7, "時間外勤務");
		attendanceStatusForOutput.put((byte) 8, "振替出勤");
		attendanceStatusForOutput.put((byte) 10, "代替出勤");
		attendanceStatusForOutput.put((byte) 1, "休日");
		attendanceStatusForOutput.put((byte) 2, "祝日");
		attendanceStatusForOutput.put((byte) 4, "有給");
		attendanceStatusForOutput.put((byte) 5, "欠勤");
		attendanceStatusForOutput.put((byte) 9, "振替休日");
		attendanceStatusForOutput.put((byte) 11, "代替休日");
	}

	//出勤系統
	static List<Byte> attendanceSystem = new ArrayList<Byte>();
	static {
